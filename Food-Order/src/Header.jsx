        ...
        <nav className="ml-auto">
          <ul className="flex items-center space-x-12">
            <li className="text-gray-900 relative group py-2 text-lg font-medium transition-transform duration-300 ">
              <Link to="/" className="group-hover:text-orange-600  transition-all duration-300 text-black">
                Home
                
              </Link>
            </li>
            <li className="text-gray-900 relative group py-2 text-lg font-medium transition-transform duration-300 ">
              <Link to="/about" className="group-hover:text-orange-600 transition-all duration-300 text-black">
                About
              </Link>
            </li>
            <li className="text-gray-900 hover:text-gray-900 relative group py-2 text-lg font-medium transition-transform duration-300 hover:scale-110">
              <Link to="/cart" className="group-hover:text-orange-600 transition-all duration-300 text-black">
                Cart
